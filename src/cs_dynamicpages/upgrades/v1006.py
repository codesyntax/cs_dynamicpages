...
def upgrade(setup_tool=None):
    """ """
    logger.info("Running upgrade (Python): Add new values on row_type_fields in registry")
    ...
    api.portal.set_registry_record(
        "cs_dynamicpages.dynamic_pages_control_panel.row_type_fields", new_row_types_fields
    )
